...
function Card(){
    ...
    return(
        <div className="mx-3">
            ...
            {/* nice purple - #af58c0 */}
            {/* Card's Front */}
            <motion.div className={`relative bg-[#af58c0] h-150 w-107 rounded-3xl flex overflow-hidden pointer-events-none ${clicked ? '' : 'pointer-events-none'}`} 
            animate={
            ...
            transition={{
                ...
                <div className="absolute inset-0 bg-repeat opacity-[0.4] bg-[url('/noise.jpg')] "/>
                    ...
                    <div className="flex items-center justify-center">
                        <img src="./energy.webp" className="w-full h-full"></img>
                    </div>
