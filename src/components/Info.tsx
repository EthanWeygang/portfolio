    ...
    return(
        ...
        <InView
            ...
            <div className="flex flex-col md:flex-row w-full justify-between items-start gap-8">
                ...
                <div className="flex flex-col md:ml-[50px] flex-9">
                ...
                <div className="flex flex-col md:mr-[50px] flex-9">
                    ...
                    <div className="flex flex-col gap-6 justify-start">
                        ...
                        >
                            ...
                            <span className="transition duration-200 ease-in-out">Email</span>
                        </a>
                        ...
                        >
                            ...
                            <span className="transition duration-200 ease-in-out">Github</span>
                        </a>
                        ...
                        >
                            ...
                            <span className="transition duration-200 ease-in-out">CV</span>
                        </a>
                        ...
                        >
                            ...
                            <span className="transition duration-200 ease-in-out">LinkedIn</span>
                        </a>
                    </div>
                </div>
            </div>
