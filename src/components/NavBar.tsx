...
return(
    ...
    <nav className="flex fixed w-full justify-between items-center z-10 space-x-1 my-8">
        ...
        <motion.div className="flex-3 px-2 mt-6 flex border-4 border-white  bg-black1 rounded-4xl" initial={{y: -110 }} animate={{y: 0}} transition={{duration: 1.5, ease: "backOut", delay: 1}}>
