    ...
    <AnimatePresence mode='wait'>
      {isOpen && (
        <motion.dialog
          ...
          className={cn(
            'fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 transform rounded-2xl border-4 border-[#0f2b57] p-0 shadow-lg dark:border dark:border-zinc-700',
...
function DialogClose({ className, children, disabled }: DialogCloseProps) {
  ...
  return (
    <button
      ...
      disabled={disabled}
    >
      {children || <X className='h-4 w-4 text-white' />}
